...
while cap.isOpened():
    ...
    time_array.append(curr_time-start_time)
...
# рисуем графики
plt.title("Colors relation")
plt.xlabel("Time, s")
plt.ylabel("Black/white percentage")
#plt.plot(x, black_array, x, white_array, x_median, median_black)
#plt.plot(x_median, median_black)
plt.plot(time_array, black_array, time_array, white_array)
plt.show()
